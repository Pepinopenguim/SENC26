...
class AutomatizadorArquivosApp:
    ...
    def _criar_componentes(self):
        ...
        # 1. Seleção de Origem (Mantido como exemplo para os alunos)
        ...
        # TODO: Desenhar a Label, Entry e Button para o diretório de destino na linha (row) 1
        # Certifique-se de associar o Entry à variável 'self.diretorio_destino'
        # O botão deve acionar o método 'self._selecionar_destino'
